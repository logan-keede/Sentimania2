...
# for i in test_set:
                    ...
                    faceAligned = Face_Alignment(inputPath)
                    # pl.imshow(faceAligned[:, :, ::-1])
                    # pl.show()
                    faceAligned, gray_img = face_detection(faceAligned)
                    # pl.imshow(img[:, :, ::-1])
                        # pl.show()
                    path = 'new'
                    output_filename = os.path.join(path, dataset_path, label, filename)
